...
name          := """get-paid"""
organization  := "io.innovations.get-paid"
version       := "0.0.1"
scalaVersion  := "2.11.7"
...
pomExtra := (
  ...
  <scm>
    <url>https://github.com/twisterius/</url>
    <connection>scm:git:git@github.com:twisterius/.git</connection>
  </scm>
  <developers>
    <developer>
      <id>twisterius</id>
      <name>Greg Karlin</name>
      <url>http://twisterius.github.io/</url>
    </developer>
  </developers>)
...
flywayUrl := "jdbc:postgresql://127.0.0.1:5432/get_paid"
